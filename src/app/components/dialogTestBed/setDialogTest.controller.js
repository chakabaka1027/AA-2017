(function() {
  ...
  angular
    .module('awkwardAnnie')
    .controller('setDialogTest', setDialogTest);

  /** @ngInject */
  function setDialogTest($log, $scope, $timeout, dialogService, parseAAContentService,Nodeservice,
 ...
 //gives c - cc - ccc
    ...
    function loadFromFile(fileObject) {
      ...
      vm.currentSource = fileObject.name + ' (local)';//TODO IS THIS THE DELAY
